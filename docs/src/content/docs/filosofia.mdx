---
title: Filosofía
description: Por qué Piola existe, por qué habla chileno, y por qué los errores te insultan.
---
...
- **De Ruby** — el tono. Ruby tiene personalidad. Los errores de Piola son herederos directos de esa filosofía.
...
Cada fase es un módulo separado con una interfaz clara. El objetivo es que leer el código fuente de Piola sea, en sí mismo, un recorrido por cómo funcionan los lenguajes por dentro.
