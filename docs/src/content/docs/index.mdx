...
hero:
  ...
  actions:
    - text: Empezar
      ...
      icon: right-arrow
    - text: Ver en GitHub
      link: https://github.com/cuervolu/wn
      icon: github
      variant: minimal
---
...
<CardGrid>
  ...
  <Card title="Para aprender cómo funciona todo" icon="open-book">
    El pipeline completo está expuesto: Lexer - Parser - AST - Intérprete. Leer el código fuente de WN++ es un recorrido por cómo funcionan los lenguajes simples por dentro.
  </Card>
