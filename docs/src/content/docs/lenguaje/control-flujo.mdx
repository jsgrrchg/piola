...
description: cachai, mientras, para, cortala y sigue — cómo dirigir la ejecución en WN++.
---

import { Aside, Tabs, TabItem, Card, CardGrid } from '@astrojs/starlight/components';

El control de flujo es lo que hace que un programa tome decisiones, repita cosas, y sepa cuándo parar. WN++ tiene lo necesario y nada más.
